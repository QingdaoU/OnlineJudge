...
languages = [
    {"config": _c_lang_config, "spj": {"compile": _c_lang_spj_compile, "config": _c_lang_spj_config},
     "name": "C", "description": "GCC 8.4", "content_type": "text/x-csrc"},
    {"config": _c_o2_lang_config, "name": "C With O2", "description": "GCC 8.4", "content_type": "text/x-csrc"},
    {"config": _cpp_lang_config, "spj": {"compile": _cpp_lang_spj_compile, "config": _cpp_lang_spj_config},
     "name": "C++", "description": "G++ 8.4", "content_type": "text/x-c++src"},
    {"config": _cpp_o2_lang_config, "name": "C++ With O2", "description": "G++ 8.4", "content_type": "text/x-c++src"},
