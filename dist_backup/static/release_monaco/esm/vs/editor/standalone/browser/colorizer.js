...
var Colorizer = /** @class */ (function () {
    ...
    Colorizer.colorizeLine = function (line, mightContainRTL, tokens, tabSize) {
        ...
        var renderResult = renderViewLine(new RenderLineInput(false, line, mightContainRTL, 0, tokens, [], tabSize, 0, -1, 'none', false, false));
...
function _fakeColorize(lines, tabSize) {
    ...
    for (var i = 0, length_1 = lines.length; i < length_1; i++) {
        ...
        var renderResult = renderViewLine(new RenderLineInput(false, line, false, 0, lineTokens, [], tabSize, 0, -1, 'none', false, false));
...
function _actualColorize(lines, tabSize, tokenizationSupport) {
    ...
    for (var i = 0, length_2 = lines.length; i < length_2; i++) {
        ...
        var renderResult = renderViewLine(new RenderLineInput(false, line, true /* check for RTL */, 0, lineTokens.inflate(), [], tabSize, 0, -1, 'none', false, false));
        html = html.concat(renderResult.html);
        html.push('<br/>');
