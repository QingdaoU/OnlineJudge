...
import { SimpleConfigurationService, SimpleResourceConfigurationService, SimpleMenuService, SimpleProgressService, StandaloneCommandService, StandaloneKeybindingService, SimpleNotificationService, StandaloneTelemetryService, SimpleWorkspaceContextService, SimpleConfirmationService } from './simpleServices.js';
...
import { IConfirmationService } from '../../../platform/dialogs/common/dialogs.js';
...
(function (StaticServices) {
    ...
    StaticServices.confirmationService = define(IConfirmationService, function () { return new SimpleConfirmationService(); });
